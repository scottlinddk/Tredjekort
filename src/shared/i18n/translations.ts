...
const translations = {
  ...
  'search.intro': { da: 'Find en adresse, og se dens omtrentlige afstand til den planlagte motorvej.', en: 'Find an address to see its approximate distance from the planned motorway.' },
